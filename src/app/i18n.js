...
const STRINGS = {
  ja: {
    ...
    detOperator: '鉄道会社の案内',
    asOf: (when) => `${when} 時点`,
    odptCredit: '公共交通オープンデータセンターのデータを利用しています',
    language: '言語',
    shareLabel: '共有',
    noResults: '見つかりません',
  ...
  en: {
    ...
    odptCredit: 'Uses data from the Public Transportation Open Data Center',
    language: 'Language',
    shareLabel: 'Share',
    noResults: 'No match',
  ...
  ko: {
    ...
    asOf: (when) => `${when} 기준`,
    odptCredit: '공공교통 오픈데이터 센터의 데이터를 이용합니다',
    language: '언어',
    shareLabel: '공유',
    noResults: '결과 없음',
