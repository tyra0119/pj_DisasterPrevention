...
const STRINGS = {
  ja: {
    ...
    chipCheck: '要確認',
    change: '変更する',
    otherQuakes: (n) => `ほか ${n} 件の地震も合わせて判定`,
    confirmedBy: '鉄道会社の運行情報で確認済み',
    detOperator: '鉄道会社の案内',
    language: '言語',
    shareLabel: '共有',
    noResults: '見つかりません',
  ...
  en: {
    ...
    chipCheck: 'Check',
    change: 'Change',
    otherQuakes: (n) => `${n} other quake${n === 1 ? '' : 's'} also considered`,
    confirmedBy: 'Confirmed by the operator’s status',
    detOperator: 'Operator says',
    language: 'Language',
    shareLabel: 'Share',
    noResults: 'No match',
  ...
  zh: {
    ...
    chipCheck: '待确认',
    change: '更改',
    otherQuakes: (n) => `另有 ${n} 次地震一并判断`,
    confirmedBy: '已由铁路公司运行信息确认',
    detOperator: '铁路公司通告',
    language: '语言',
    shareLabel: '分享',
    noResults: '没有找到',
  ...
  ko: {
    ...
    chipCheck: '확인 필요',
    change: '변경',
    otherQuakes: (n) => `다른 지진 ${n}건도 함께 판단`,
    confirmedBy: '철도 회사 운행 정보로 확인됨',
    detOperator: '철도 회사 안내',
    language: '언어',
    shareLabel: '공유',
    noResults: '결과 없음',
