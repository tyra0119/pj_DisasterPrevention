...
`npm run verify:shindo` / `verify:rail` / `verify:systems` / `verify:regulation` で再現できる。

## 停止推定

高浜勉・翠川三郎「地震時の鉄道運休時間の推定方法」日本地震工学会論文集 第11巻第2号 (2011) 表1。
...
L は点検区間長(km)。式は `T = 6.0×L ± 30`。国土交通省
「大規模地震発生時における首都圏鉄道の運転再開のあり方に関する協議会」報告書 (2012)
の実施基準の例とも整合する (震度4で55km/h以下、5弱で25km/h以下、5強以上は点検まで運転中止)。
https://www.mlit.go.jp/common/000208774.pdf

2026-08-23 茨城県南部 M5.9 最大震度5弱 での出力:

```
山手線          震度5-  待つ  徒歩点検  1時間44分〜5時間35分  系統 35.7km (営業キロ 34.5km)
中央線快速       震度5-  待つ  徒歩点検  1時間13分〜4時間23分  系統 54.4km (53.1km)
京浜東北線・根岸線   震度5-  待つ  徒歩点検   3時間15分〜9時間9分  系統 110.5km (81.2km)
京急空港線       震度5-  待つ  徒歩点検      35分〜2時間1分  系統 10.2km (6.5km)
東海道新幹線      震度5-  待つ  徒歩点検     51分〜1時間51分  区間不明 (安全側に倒した)
```

実際にこの地震では JR東日本が関東の在来線で始発から運転を見合わせ、
発生 4時間15分後の 06:15 時点でも再開見込みが立っていなかった。上の幅と整合する。
...
scripts/                       ビルド時のみ。配信には不要 (置いてあるだけ)
  ...
  verify-regulation.mjs        停止推定を検証      npm run verify:regulation
...
高浜・翠川 (2011) 日本地震工学会論文集 11(2) / 国土交通省 (2012) 首都圏鉄道の運転再開のあり方
