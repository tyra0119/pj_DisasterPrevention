...
/** 画面の骨格。これが無いと何も出せない。 */
const SHELL_FILES = ['./', 'index.html', 'manual.html', 'diagnostics.html', 'test.html', 'sw.js']
...
self.addEventListener('fetch', (event) => {
  ...
  // 運行情報も同じ。古い運行情報を返すのは、古い地震を返すのと同じくらい危ない。
  if (url.hostname.endsWith('workers.dev') || url.hostname.endsWith('odpt.org')) return
